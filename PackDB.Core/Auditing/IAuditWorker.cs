...
{
    /// <summary>
    ///     The audit worker is responsible for managing the operations of writing events to the audit and returning them when
    ///     requested.
    /// </summary>
    public interface IAuditWorker
    {
        ...
        /// <summary>
        ///     The CommitEvents method is called when the data manager has commited the data and want the audit to be commited to
        ///     the data store.
        /// </summary>
        ...
        /// <summary>
        ///     The DiscardEvents method is called when the data manager has failed commited the data and want the audit events
        ///     that are staged to be discarded.
        /// </summary>
        /// <param name="data">data object to help find staged events</param>
